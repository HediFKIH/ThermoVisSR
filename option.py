...
parser.add_argument('--stv_w', type=float, default=0,
                    help='The weight of STV loss')
...
parser.add_argument('--dim4', type=int, default=512,
                    help='dimension of input')
parser.add_argument('--dim3', type=int, default=256,
                    help='dimension of input')
...
parser.add_argument('--depth', type=int, default=12,
                    help='depth')
parser.add_argument('--reversible', type=str2bool, default=True,
                    help='reversible mode')
parser.add_argument('--train_crop_size', type=int, default=45,
...
parser.add_argument('--test', type=str2bool, default=False,
                    help='Test mode')
parser.add_argument('--lr_vis_path', type=str, default='./test/demo/lr_vis/7.jpg',
                    help='The path of input lr image when testing')
parser.add_argument('--lr_thr_path', type=str, default='./test/demo/lr_thr/7.jpg',
                    help='The path of input lr image when testing')
parser.add_argument('--ref_vis_path', type=str, default='./test/demo/ref_vis/7.jpg',
                    help='The path of ref image when testing')
parser.add_argument('--ref_thr_path', type=str, default='./test/demo/ref_thr/7.jpg',
                    help='The path of ref image when testing')
